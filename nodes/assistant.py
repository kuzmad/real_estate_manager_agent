...
assistant_prompt = ChatPromptTemplate.from_messages([
    ...
    Отвечай естественно и по-человечески.
     ...
     ВАЖНО: История диалога показывает предыдущие сообщения.
     Учитывай контекст — если пользователь отвечает на твой вопрос,
     не начинай разговор заново. Продолжай диалог естественно.
